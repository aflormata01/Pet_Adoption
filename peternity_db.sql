...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2017 at 06:24 AM
...
INSERT INTO `owneraccount` (`username`, `email`, `password`, `date_signedup`) VALUES
('aflormata', '', '1234', '2017-07-08'),
('aflormatas', 'asa@alvin', '123', ''),
('alesa', '', '123', ''),
('dale', '', '213', ''),
('dale09', '', '213', '');
...
INSERT INTO `ownerinfo` (`username`, `fname`, `lname`, `photo`, `email`, `birthdate`, `sex`, `password`) VALUES
('aflormata', 'Allysa', 'Flormata', NULL, '@aflormata01', '2000-01-01', 'Female', 0),
('alexiamndz', 'Alexia', 'Armando', NULL, '@alexiamndz', '1999-04-04', 'Female', 0),
('sdf', 'asfa', 'df', NULL, '', '2017-10-05', 'M', 12),
('sdf', 'asfa', 'df', NULL, '', '2017-10-05', 'M', 123),
('adsfa', 'safdfasd', 'sadf', NULL, '', '2017-10-12', 'F', 123),
('alesa', 'Allysa', 'Flormata', NULL, '', '', '', 0),
('aflormata', 'Allysa', 'Flormata', NULL, 'a@aflormata01', '2000-01-01', 'M', 0),
('aflormata', 'Allysa', 'Flormata', NULL, 'a@aflormata01', '2000-01-01', 'M', 0),
('dale', 'alvin', 'angeles', NULL, '', '', '', 0),
('dale09', 'alvin', 'angeles', NULL, '', '', '', 0);
...
INSERT INTO `stories` (`story#`, `username`, `title`, `body`, `file_name`, `date`, `time`) VALUES
...
(12, '', 'fghfgdhfdg', 0x68666764686664676866676468, './assets/uploads/2681259e59a7bb23c9.jpg', '', '');
...
--
ALTER TABLE `stories`
  MODIFY `story#` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
