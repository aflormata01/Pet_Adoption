...
<div class="container text-center">    
  ...
  <div class="col-md-12 ">
	 <p>
		<a href="<?php echo base_url('user/petcatalogue')?>" style="text-decoration:none"><button type="button" class="btn btn-lg button1"><h4 class="heading">Pet Catalogue</h4></a></button>&nbsp;&nbsp;&nbsp;&nbsp;
