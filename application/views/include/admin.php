    ...
    <nav class="navbar" role="navigation">
        ...
        <ul class="nav navbar-nav" class="text-left"><h3 class="text-center" style="padding-left: 70px;"><img src="<?php echo base_url('assets/images/logo.png')?>"></h3> </ul>
		
		
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown"><a href="#" class="dropdown-toggle heading sm" data-toggle="dropdown"><span
