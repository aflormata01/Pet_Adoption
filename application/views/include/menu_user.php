<nav class="navbar navbar-default">
  <div class="container search">
    ...
    <ul class="nav navbar-nav">
	  ...
	  <li class="menupad"><a class="u" href="<?php echo base_url('user/petcatalogue')?>">PET CATALOGUE</a></li>
      ...
      <li class="dropdown menupad">
        ...
        <ul class="dropdown-menu">
          ...
          <li class="menupad"><a href="<?php echo base_url('user/upcomingevents')?>">UPCOMING EVENTS</a></li>
        </ul>
      </li>
