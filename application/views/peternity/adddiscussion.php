 <?php echo form_open('peternity/addDiscussion'); //this is equal to <form method="post" accept-charset="utf-8" action="http://localhost/Pet_Adoption/peternity/addDiscussion"?>
